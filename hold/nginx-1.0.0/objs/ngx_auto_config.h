#define NGX_CONFIGURE " --with-pcre --add-module=/opt/ruby/lib/ruby/gems/1.9.1/gems/passenger-3.0.7/ext/nginx --prefix=/usr"
...
#define PASSENGER_NGINX_MINOR_VERSION  0
#endif


#ifndef PASSENGER_NGINX_MICRO_VERSION
#define PASSENGER_NGINX_MICRO_VERSION  0
#endif
